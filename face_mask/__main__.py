...
def cli():
    ...
    # parser.add_argument('pic_path', default="C://Users//2014Vee//Desktop", help='Picture path.')
    ...
    FaceMasker("./face/1-1.jpg", DEFAULT_IMAGE_PATH, False, 'hog').mask()
    # FaceMasker("./face/3.jpg", DEFAULT_IMAGE_PATH, False, 'hog').mask()
    # FaceMasker("./face/4.jpg", DEFAULT_IMAGE_PATH, False, 'hog').mask()
    # FaceMasker("./face/5.jpg", DEFAULT_IMAGE_PATH, False, 'hog').mask()
